...
class MUXClient {
  ...
  initializeDio() {
    BaseOptions options = BaseOptions(
      ...
      connectTimeout: Duration(milliseconds: 8000),  // Wrap in Duration
      receiveTimeout: Duration(milliseconds: 5000),  // Wrap in Duration
      headers: {
  ...
  Future<AssetData?> get getAssetList async {
    try {
      Response response = await _dio.get(
        "/assets",
      );
